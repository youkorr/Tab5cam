"""
Sensor SC2336 pour MIPI-CSI - Configuration 720P@30fps RAW8
...
# ============================================================================
# SÉQUENCE D'INITIALISATION 720P @ 30FPS RAW8
# ============================================================================
...
INIT_SEQUENCE = [
    ...
    # Window and resolution 1280x720
    (0x3200, 0x01, 0),
    (0x3201, 0x34, 0),
    (0x3202, 0x00, 0),
    (0x3203, 0xb4, 0),
...
# ============================================================================
# TABLE DE GAIN (Digital Gain Priority)
# ============================================================================
...
GAIN_REGISTERS = [
    # 1X (digital fine, digital coarse, analog)
