...
bool Tab5Camera::init_camera_() {
  ...
  this->camera_config_.pin_reset = this->reset_pin_ ? this->reset_pin_->GPIOPin() : -1;
  this->camera_config_.pin_xclk = this->ext_clock_pin_ ? this->ext_clock_pin_->get_pin() : 36;
