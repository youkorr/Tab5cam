"""
Sensor OV5647 pour MIPI-CSI - Configuration 800x640@50fps RAW8
...
SENSOR_INFO = {
    ...
    'i2c_address': 0x36,
    'lane_count': 2,
    'bayer_pattern': 3,  # BGGR (typique pour OV5647)
    'lane_bitrate_mbps': 400,  # 100MHz * 4
    'width': 800,
    'height': 640,
    'fps': 50,
}
...
# ============================================================================
# SÉQUENCE D'INITIALISATION 800x640 @ 50FPS RAW8
# ============================================================================

INIT_SEQUENCE = [
    # Reset sequence
    (0x0100, 0x00, 0),   # sleep mode
    (0x0103, 0x01, 10),  # software reset + delay 10ms
    (0x4800, 0x01, 0),   # ensure streaming off
    
    # Core configuration RAW8
    (0x3034, 0x18, 0),   # RAW8 mode
    (0x3035, 0x41, 0),   # system clock divider
    (0x3036, 0x80, 0),   # PLL multiplier (128 for 100MHz IDI clock)
    (0x303c, 0x11, 0),
    (0x3106, 0xf5, 0),
    (0x3821, 0x03, 0),   # mirror, binning
    (0x3820, 0x41, 0),   # flip, binning
    (0x3827, 0xec, 0),
    (0x370c, 0x0f, 0),
    (0x3612, 0x59, 0),
    (0x3618, 0x00, 0),
    (0x5000, 0xff, 0),   # LENC enable
    ...
    # HTS (line exposure time in pixels) = 1896
    (0x380c, 0x07, 0),
    (0x380d, 0x68, 0),
    # VTS (frame exposure time in lines) = 984
    (0x380e, 0x03, 0),
    (0x380f, 0xd8, 0),
    
    # Subsampling
    (0x3814, 0x31, 0),   # horizontal
    (0x3815, 0x31, 0),   # vertical
    ...
    # MIPI timing
    (0x4837, 0x14, 0),   # PCLK period (ns) = 20ns for 50fps
...
// Resolution: {SENSOR_INFO['width']}x{SENSOR_INFO['height']}@{SENSOR_INFO['fps']}fps RAW8
// =============================================================================
